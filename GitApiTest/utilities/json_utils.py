...
def remove_fields(origin_dict, field_names):
    """
    удаляет указанные ключи из словаря, в которых есть
    :param field_names: ключи к удалению
    :param origin_dict: исходный словарь
    :return: словарь с выпиленными ключами
    """
